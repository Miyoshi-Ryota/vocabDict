...
//
//   const lookupWordResponse = Convert.toLookupWordResponse(json);
//
...
function toLookupWordResponse(json) {
    return cast(JSON.parse(json), r("LookupWordResponse"));
}

function lookupWordResponseToJson(value) {
    return JSON.stringify(uncast(value, r("LookupWordResponse")), null, 2);
}
...
module.exports = {
    "lookupWordResponseToJson": lookupWordResponseToJson,
    "toLookupWordResponse": toLookupWordResponse,
};
