...
//
//   const fetchVocabularyListWordsResponse = Convert.toFetchVocabularyListWordsResponse(json);
//
...
function toFetchVocabularyListWordsResponse(json) {
    return cast(JSON.parse(json), r("FetchVocabularyListWordsResponse"));
}

function fetchVocabularyListWordsResponseToJson(value) {
    return JSON.stringify(uncast(value, r("FetchVocabularyListWordsResponse")), null, 2);
}
...
module.exports = {
    "fetchVocabularyListWordsResponseToJson": fetchVocabularyListWordsResponseToJson,
    "toFetchVocabularyListWordsResponse": toFetchVocabularyListWordsResponse,
};
