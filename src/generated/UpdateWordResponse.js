...
//
//   const updateWordResponse = Convert.toUpdateWordResponse(json);
//
...
function toUpdateWordResponse(json) {
    return cast(JSON.parse(json), r("UpdateWordResponse"));
}

function updateWordResponseToJson(value) {
    return JSON.stringify(uncast(value, r("UpdateWordResponse")), null, 2);
}
...
module.exports = {
    "updateWordResponseToJson": updateWordResponseToJson,
    "toUpdateWordResponse": toUpdateWordResponse,
};
