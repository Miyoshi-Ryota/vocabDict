...
//
//   const updateSettingsRequest = Convert.toUpdateSettingsRequest(json);
//
...
function toUpdateSettingsRequest(json) {
    return cast(JSON.parse(json), r("UpdateSettingsRequest"));
}

function updateSettingsRequestToJson(value) {
    return JSON.stringify(uncast(value, r("UpdateSettingsRequest")), null, 2);
}
...
module.exports = {
    "updateSettingsRequestToJson": updateSettingsRequestToJson,
    "toUpdateSettingsRequest": toUpdateSettingsRequest,
};
